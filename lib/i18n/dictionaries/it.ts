...
export const dictionary: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'TikTok Wrapped è gestito da AffSquad ed è raggiungibile all\'indirizzo [[email:hello@affsquad.com]]. È uno strumento indipendente e non ufficiale, non affiliato, sostenuto o collegato a TikTok o ByteDance Ltd.',
    ],
  ...
  privacy: {
    ...
    sections: [
      { title: '1. Chi siamo (Titolare del trattamento)', paragraphs: ['TikTok Wrapped è gestito da AffSquad, il titolare del trattamento responsabile di questo sito web. Se hai domande sulla presente informativa o su come vengono trattati i tuoi dati, puoi contattarci all\'indirizzo [[email:hello@affsquad.com]] o tramite la nostra pagina [[contact:Contatti]].'] },
      ...
      { title: '16. Contatti', paragraphs: ['Domande sulla presente Informativa sulla privacy? Scrivi a [[email:hello@affsquad.com]] o utilizza la nostra pagina [[contact:Contatti]].'] },
    ],
  },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'Contatti', paragraphs: ['Domande sui presenti Termini? Scrivi a [[email:hello@affsquad.com]] o utilizza la nostra pagina [[contact:Contatti]].'] },
    ],
  },
  ...
  meta: {
    ...
    contact: {
      ...
      description:
        'Contatta TikTok Wrapped per domande sul servizio, sulla privacy, su problemi tecnici o questioni legali. Email: hello@affsquad.com',
    },
    privacy: {
