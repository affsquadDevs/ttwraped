...
export const dictionary: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'TikTok Wrapped wird von AffSquad betrieben und ist unter [[email:hello@ttwrapper.com]] erreichbar. Es ist ein unabhängiges, inoffizielles Tool und ist nicht verbunden mit, unterstützt von oder in Verbindung mit TikTok oder ByteDance Ltd.',
    ],
    faqTitle: 'FAQ',
    faq: [
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '11. Deine Datenschutzrechte (DSGVO/UK-DSGVO)', paragraphs: ['Wenn du dich im EWR oder im Vereinigten Königreich befindest, hast du das Recht auf Auskunft, Berichtigung, Löschung, Einschränkung oder Widerspruch gegen die Verarbeitung deiner personenbezogenen Daten sowie das Recht auf Datenübertragbarkeit und auf jederzeitigen Widerruf der Einwilligung. Um diese Rechte auszuüben, kontaktiere uns unter [[email:hello@ttwrapper.com]]. Du hast außerdem das Recht, eine Beschwerde bei deiner lokalen Datenschutzbehörde einzureichen.'] },
      { title: '12. Datenschutzrechte in Kalifornien (CCPA/CPRA)', paragraphs: ['Einwohner Kaliforniens haben das Recht zu erfahren, welche personenbezogenen Daten erhoben werden, deren Löschung zu verlangen und dem „Verkauf“ oder der „Weitergabe“ personenbezogener Daten zu widersprechen. Wir verkaufen keine personenbezogenen Daten. Um deine Rechte auszuüben, kontaktiere uns unter [[email:hello@ttwrapper.com]].'] },
      ...
      { title: '16. Kontakt', paragraphs: ['Fragen zu dieser Datenschutzerklärung? Schreibe an [[email:hello@ttwrapper.com]] oder nutze unsere [[contact:Kontakt]]-Seite.'] },
    ],
  },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'Kontakt', paragraphs: ['Fragen zu diesen Bedingungen? Schreibe an [[email:hello@ttwrapper.com]] oder nutze unsere [[contact:Kontakt]]-Seite.'] },
    ],
  },
  ...
  meta: {
    ...
    contact: {
      ...
      description:
        'Kontaktiere TikTok Wrapped bei Fragen zum Dienst, zum Datenschutz, zu technischen Problemen oder rechtlichen Angelegenheiten. E-Mail: hello@ttwrapper.com',
    },
    privacy: {
