...
export const dictionary: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'TikTok Wrapped está operado por AffSquad y puedes contactarnos en [[email:hello@affsquad.com]]. Es una herramienta independiente y no oficial, y no está afiliada, respaldada ni conectada con TikTok ni ByteDance Ltd.',
    ],
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '16. Contacto', paragraphs: ['¿Preguntas sobre esta Política de Privacidad? Escribe a [[email:hello@affsquad.com]] o utiliza nuestra página de [[contact:Contacto]].'] },
    ],
  },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'Contacto', paragraphs: ['¿Preguntas sobre estos Términos? Escribe a [[email:hello@affsquad.com]] o utiliza nuestra página de [[contact:Contacto]].'] },
    ],
  },
  ...
  meta: {
    home: {
      title: 'TikTok Wrapped (no oficial) — Analiza tus datos y estadísticas de TikTok',
      description:
        'TikTok Wrapped es una herramienta independiente y no oficial que analiza la exportación oficial de tus datos de TikTok para revelar tu tiempo de visualización, tus búsquedas principales, tu contenido favorito y un divertido rango de personalidad. Privada, gratuita y no afiliada a TikTok ni ByteDance Ltd.',
    },
    analyze: {
    ...
    contact: {
      ...
      description:
        'Contacta con TikTok Wrapped para consultas sobre el servicio, la privacidad, problemas técnicos o asuntos legales. Correo electrónico: hello@affsquad.com',
    },
    privacy: {
