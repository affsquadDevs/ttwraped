...
export const dictionary: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'O TikTok Wrapped é operado pela AffSquad e pode ser contactado através de [[email:hello@affsquad.com]]. É uma ferramenta independente e não oficial, sem qualquer afiliação, aprovação ou ligação ao TikTok ou à ByteDance Ltd.',
    ],
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '16. Contacto', paragraphs: ['Tem questões sobre esta Política de Privacidade? Envie um e-mail para [[email:hello@affsquad.com]] ou utilize a nossa página de [[contact:Contacto]].'] },
    ],
  },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'Contacto', paragraphs: ['Tem questões sobre estes Termos? Envie um e-mail para [[email:hello@affsquad.com]] ou utilize a nossa página de [[contact:Contacto]].'] },
    ],
  },
  ...
  meta: {
    ...
    contact: {
      ...
      description:
        'Contacte o TikTok Wrapped para questões sobre o serviço, privacidade, problemas técnicos ou assuntos legais. E-mail: hello@affsquad.com',
    },
    privacy: {
