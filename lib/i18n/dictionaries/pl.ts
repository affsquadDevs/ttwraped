...
export const dictionary: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      'TikTok Wrapped jest prowadzone przez AffSquad i można się z nami skontaktować pod adresem [[email:hello@affsquad.com]]. Jest to niezależne, nieoficjalne narzędzie, niepowiązane z TikTok ani ByteDance Ltd. oraz nieuznawane i niewspierane przez te firmy.',
    ],
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '16. Kontakt', paragraphs: ['Masz pytania dotyczące niniejszej Polityki prywatności? Napisz na [[email:hello@affsquad.com]] lub skorzystaj z naszej strony [[contact:Kontakt]].'] },
    ],
  },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'Kontakt', paragraphs: ['Masz pytania dotyczące niniejszego Regulaminu? Napisz na [[email:hello@affsquad.com]] lub skorzystaj z naszej strony [[contact:Kontakt]].'] },
    ],
  },
  ...
  meta: {
    ...
    contact: {
      ...
      description:
        'Skontaktuj się z TikTok Wrapped w sprawie pytań o usługę, prywatność, problemy techniczne lub kwestie prawne. E-mail: hello@affsquad.com',
    },
    privacy: {
