...
export default function AnalyzeWrapped() {
  ...
  return (
    <div className="container">
      <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
        <a href="/" style={{ color: '#25f4ee', textDecoration: 'none', fontSize: '1rem' }}>← Back to Home</a>
        <h1 style={{ marginTop: '1rem', fontSize: '2.5rem' }}>
          <span style={{ color: '#25f4ee' }}>Tik</span><span style={{ color: '#fe2c55' }}>Tok</span> 
          <span style={{ color: '#fff' }}> Wrapped</span>
        </h1>
        <p style={{ color: 'rgba(255,255,255,0.7)', marginTop: '0.5rem' }}>Analyze Your TikTok Data</p>
      </div>
