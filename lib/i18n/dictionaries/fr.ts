...
export const dictionary: Dictionary = {
  ...
  about: {
    ...
    paragraphs: [
      ...
      "TikTok Wrapped est exploité par AffSquad et peut être contacté à l'adresse [[email:hello@affsquad.com]]. C'est un outil indépendant et non officiel, sans aucune affiliation, approbation ni lien avec TikTok ou ByteDance Ltd.",
    ],
    faqTitle: 'FAQ',
    faq: [
  ...
  privacy: {
    ...
    sections: [
      ...
      { title: '11. Vos droits en matière de confidentialité (RGPD / RGPD britannique)', paragraphs: ["Si vous résidez dans l'EEE ou au Royaume-Uni, vous disposez du droit d'accès, de rectification, d'effacement, de limitation ou d'opposition au traitement de vos données personnelles, ainsi que du droit à la portabilité des données et du droit de retirer votre consentement à tout moment. Pour exercer ces droits, contactez-nous à l'adresse [[email:hello@affsquad.com]]. Vous avez également le droit d'introduire une réclamation auprès de votre autorité locale de protection des données."] },
      { title: '12. Droits à la vie privée en Californie (CCPA / CPRA)', paragraphs: ["Les résidents de Californie ont le droit de savoir quelles informations personnelles sont collectées, de demander leur suppression et de refuser la « vente » ou le « partage » de leurs informations personnelles. Nous ne vendons pas d'informations personnelles. Pour exercer vos droits, contactez-nous à l'adresse [[email:hello@affsquad.com]]."] },
      ...
      { title: '16. Contact', paragraphs: ["Des questions sur cette politique de confidentialité ? Écrivez à [[email:hello@affsquad.com]] ou utilisez notre page [[contact:Contact]]."] },
    ],
  },
  ...
  terms: {
    ...
    sections: [
      ...
      { title: 'Contact', paragraphs: ["Des questions sur ces conditions ? Écrivez à [[email:hello@affsquad.com]] ou utilisez notre page [[contact:Contact]]."] },
    ],
  },
  ...
  meta: {
    ...
    contact: {
      ...
      description:
        'Contactez TikTok Wrapped pour toute question sur le service, la confidentialité, des problèmes techniques ou des sujets juridiques. E-mail : hello@affsquad.com',
    },
    privacy: {
